        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex items-center gap-3">
              <img src={Logo} alt="LandingPageAI" className="w-10 h-10" />
          ...
          >
            ...
            <div
              className="lg:min-w-max flex items-center sm:w-max 
            w-full pb-6 lg:pb-0 border-b border-box lg:border-0
            px-6 lg:px-0"
            >
          ...
          <div className="min-w-max flex items-center gap-x-3 ">
            <button
              ...
              text-heading-2 rounded-full p-2 lg:p-3 border border-box cursor-pointer"
            >
              {theme === "dark" ? (
                <svg
